...
// include "ajax.php";
$rs = mysqli_query($conexao, "SELECT * FROM unidadesacademicas ORDER BY nomedaunidade ASC");
...
<?php
                ...
                $fichaAutorNome = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaAutorNome
                );
                ...
                $fichaAutorSobrenome = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaAutorSobrenome
                );
                ...
                $fichaCoautorSobrenome = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaCoautorSobrenome
                );
                ...
                $fichaNomeOrientador = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaNomeOrientador
                );
                ...
                $fichaSobrenomeOrientador = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaSobrenomeOrientador
                );
                ...
                $fichaNomeCoorientador = preg_replace(
                    array("/\bDe\b/", "/\bDo\b/", "/\bDos\b/", "/\bDa\b/", "/\bDas\b/"),
                    array("de", "do", "dos", "da", "das"),
                    $fichaNomeCoorientador
                );
